...
<head>
    ...
    <!-- Favicon icon -->
    <link rel="icon" type="image/png" sizes="16x16" href="dashboard_assestimages/favicon.png">
    <!-- Pignose Calender -->
    <link href="dashboard_assest/plugins/pg-calendar/css/pignose.calendar.min.css" rel="stylesheet">
    <!-- Chartist -->
    <link rel="stylesheet" href="dashboard_assest/plugins/chartist/css/chartist.min.css">
    <link rel="stylesheet" href="dashboard_assest/plugins/chartist-plugin-tooltips/css/chartist-plugin-tooltip.css">
    <!-- Custom Stylesheet -->
...
<body>
                            ...
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-body pb-0 d-flex justify-content-between">
                                        <div>
                                            <h1 class="mb-1">Welcome <span>Back</span> </h1>
                                            <p></p>
    ...
    ***********************************-->
    ...
    <!-- Chartjs -->
    <script src="dashboard_assest/plugins/chart.js/Chart.bundle.min.js"></script>
    <!-- Circle progress -->
    <script src="dashboard_assest/plugins/circle-progress/circle-progress.min.js"></script>
    <!-- Datamap -->
    <script src="dashboard_assest/plugins/d3v3/index.js"></script>
    <script src="dashboard_assest/plugins/topojson/topojson.min.js"></script>
    <script src="dashboard_assest/plugins/datamaps/datamaps.world.min.js"></script>
    <!-- Morrisjs -->
    <script src="dashboard_assest/plugins/raphael/raphael.min.js"></script>
    <script src="dashboard_assest/plugins/morris/morris.min.js"></script>
    <!-- Pignose Calender -->
    <script src="dashboard_assest/plugins/moment/moment.min.js"></script>
    <script src="dashboard_assest/plugins/pg-calendar/js/pignose.calendar.min.js"></script>
    <!-- ChartistJS -->
    <script src="dashboard_assest/plugins/chartist/js/chartist.min.js"></script>
    <script src="dashboard_assest/plugins/chartist-plugin-tooltips/js/chartist-plugin-tooltip.min.js"></script>



    <script src="dashboard_assest/js/dashboard/dashboard-1.js"></script>
