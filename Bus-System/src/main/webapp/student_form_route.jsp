                                            ...
                                            <tr>
                                                <td><%=s.getStop_no() %></td>
											     ...
											     <td><%=s.getDriver_name() %></td>
											      ...
											      <td><%=s.getDept() %></td>
											      <td><%=s.getCourse() %></td>
											      <td><img src="data:image/*;base64, <%=base64Image%>" alt="" class="img-d img-fluid" style="height: 120px;width:80px"></td>
												  <td><a href="viewImage.jsp?id=<%=s.getId()%>"><img src="data:image/*;base64, <%=base64Image1%>" alt="" class="img-d img-fluid" style="height: 120px;width:80px"></a></td>
