...
<form action="Login_servlet" method="post" style="background-color:  rgb(20 23 26)">>
          ...
          <div class="row g-0">
            ...
            <div class="col-xl-6">
              <div class="card-body p-md-5 text-black">
                ...
                <label class="form-label " style="margin-right: 18px ; margin-top: 5px" for="form3Example97">Not Register :</label>
                   <a href="student_registration.jsp" class="btn btn-primary btn-lg">Register</a>
